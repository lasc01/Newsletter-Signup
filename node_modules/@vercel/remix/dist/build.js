...
const build = async ({ entrypoint, files, workPath, repoRootPath, config, meta = {}, }) => {
    ...
    let remixConfig = await (0, config_1.readConfig)(entrypointFsDirname);
...
module.exports = config;`;
    ...
    const [staticFiles, nodeFunction, edgeFunction] = await Promise.all([
        ...
        createRenderNodeFunction(entrypointFsDirname, repoRootPath, serverBuildPath, serverEntryPoint, nodeVersion),
        hasEdgeRoute
            ? createRenderEdgeFunction(entrypointFsDirname, repoRootPath, serverBuildPath, serverEntryPoint)
            : undefined,
    ]);
